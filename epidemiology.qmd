...
develop AMD worldwide.^[https://www.cdc.gov/visionhealth/vehss/estimates/amd-prevalence.html] Age is the most significant risk factor for
...
the US.^[https://www.cdc.gov/visionhealth/vehss/estimates/amd-prevalence.html] The prevalence of AMD by age group is shown in @fig-age.
...
Non-hispanic Black populations are at lowest risk for developing AMD,and Non-hispanic White populations are twice as likely to develop AMD. ^[https://www.cdc.gov/visionhealth/vehss/estimates/amd-prevalence.html]
One proposed theory is that lighter irises common in Caucasians may provide less protection against developing AMD (see *Sun protection* section of Prevention page). @fig-race shows the prevalence of AMD for each race/ethnic group.
...
AMD is more likely to occur if you:^[https://www.cdc.gov/visionhealth/resources/features/macular-degeneration.html;
